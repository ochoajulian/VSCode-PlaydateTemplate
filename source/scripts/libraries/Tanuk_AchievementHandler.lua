...
function Tanuk_AchievementHandler:init(arrAchievements, fnNotification, frameCheck, fntPath, imgNotificationPath, imgIconPath)
    ...
    local fntPath = fntPath or "/fonts/font-full-circle"
    local imgNotificationPath = imgNotificationPath or "/images/notification"
    local imgIconPath = imgIconPath or "/images/icon"
